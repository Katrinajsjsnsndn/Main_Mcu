...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_btn_1, 77, 27);
    ...
    lv_obj_set_pos(ui->screen_label_1, 265, 40);
    ...
    lv_img_set_src(ui->screen_img_1, &_1663864903058_alpha_100x100);
    lv_img_set_pivot(ui->screen_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_1, 0);
    lv_obj_set_pos(ui->screen_img_1, 147, 92);
